...
class Chatbot:
    ...
    def conversational_chat(self, query):
        ...
        If question contains wallet address, output investing style with bullet point in the begining.
        ...
        Include the sentence "Next action: Kindly tell me 'Launch', once you are ready to tokenize and fair launch your portfolio model.🚀" with a new line at the end if and only if the question contains wallet address. 
        context: {context}
        final_str: {final_str}
        =========
        question: {question}
